...
function postTool(){
    ...
    $.ajax({
        url:"http://129.151.123.186:8080/api/Tool/save",
        type:"POST",
        datatype:"JSON",
...
function putTool(idBotonActualizar){
    ...
    $.ajax({
        url:"http://129.151.123.186:8080/api/Tool/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteTool( idBotonBorrar){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url:"http://129.151.123.186:8080/api/Tool/"+ idBotonBorrar,
                type:"DELETE",
                datatype:"JSON",
                data: JSON.stringify(myData),
                contentType:"application/json",
                success:function(respuesta){
                alert("se borro correctamente la herramienta");
                    window.location.reload();
                }
            });
...
function getTool_Category(){
    ...
    $.ajax({
        url:"http://129.151.123.186:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
